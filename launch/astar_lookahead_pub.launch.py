"""
A* Lookahead Publisher Launch File

This launch file starts the A* lookahead publisher node that generates
...
def generate_launch_description():
    """
    Generate the launch description for the A* lookahead publisher.
    ...
    param_path = os.path.join(get_package_share_directory(
        "trajectory_planning"), "config", "astar_lookahead_pub_config.yaml")
